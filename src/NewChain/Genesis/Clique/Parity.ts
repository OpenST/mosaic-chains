...
export default class CliqueParityGenesis {
  ...
  public static appendAddresses(genesis: any, sealer: string, deployer: string): any {
    ...
    genesis.genesis.extraData = CliqueParityGenesis.generateSealerExtraData(sealer);
    return genesis;
  }
